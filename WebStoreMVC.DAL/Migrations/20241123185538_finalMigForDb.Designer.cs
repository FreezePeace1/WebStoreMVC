...
namespace WebStoreMVC.DAL.Migrations
{
    ...
    [Migration("20241123185538_finalMigForDb")]
    partial class finalMigForDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebStoreMVC.Domain.Entities.CustomerInfo", b =>
                {
                    b.HasOne("WebStoreMVC.Domain.Entities.AppUser", "AppUser")
                        ...
                        .HasForeignKey("WebStoreMVC.Domain.Entities.CustomerInfo", "AppUserId");
            ...
            modelBuilder.Entity("WebStoreMVC.Domain.Entities.Order", b =>
                {
                    b.HasOne("WebStoreMVC.Domain.Entities.AppUser", "AppUser")
                        .WithOne("Order")
                        .HasForeignKey("WebStoreMVC.Domain.Entities.Order", "AppUserId");
            ...
            modelBuilder.Entity("WebStoreMVC.Domain.Entities.Product", b =>
                {
                    b.HasOne("WebStoreMVC.Domain.Entities.Category", "Category")
                        .WithOne("Product")
                        .HasForeignKey("WebStoreMVC.Domain.Entities.Product", "CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebStoreMVC.Domain.Entities.Color", "Color")
                        .WithOne("Product")
                        .HasForeignKey("WebStoreMVC.Domain.Entities.Product", "ColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebStoreMVC.Domain.Entities.Manufacturer", "Manufacturer")
                        .WithOne("Product")
                        .HasForeignKey("WebStoreMVC.Domain.Entities.Product", "ManufacturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebStoreMVC.Domain.Entities.UserReview", b =>
                {
                    b.HasOne("WebStoreMVC.Domain.Entities.AppUser", "AppUser")
                        .WithOne("UserReview")
                        .HasForeignKey("WebStoreMVC.Domain.Entities.UserReview", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
